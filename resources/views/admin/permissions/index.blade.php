...
@section('page_header', 'Permisos')
@section('page_subtitle', 'Gestioná los permisos del sistema')

@section('page_actions')
    <a href="{{ route('admin.permissions.create') }}" class="btn btn-outline-dark">
        Crear permiso
    </a>
@endsection
...
@section('content')
    ...
    <div class="card shadow-sm border-0 mb-3 user-filter-card">
        <div class="card-body py-3">
            <form method="GET" action="{{ route('admin.permissions.index') }}" class="d-flex flex-wrap gap-3 align-items-end">
                ...
                <div class="d-flex gap-2 align-items-end">
                    ...
                    @if(request('search'))
                        <a href="{{ route('admin.permissions.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                            Limpiar
                        </a>
                    @endif
                </div>
    ...
    {{-- Tabla --}}
    <div class="card shadow-sm border-0 permissions-table-card">
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover table-borderless align-middle mb-0 permissions-table">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-2 align-items-center permission-actions">
                                        ...
                                        <form action="{{ route('admin.permissions.destroy', $permission) }}" method="POST" onsubmit="return confirm('¿Seguro que querés eliminar este permiso?');" class="m-0">
                                            @csrf
                                            @method('DELETE')
...
<style>
    ...
    .permissions-table tbody tr:not(:last-child) td {
